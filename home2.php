                ...
                <?php if($_GET['o'] == 'add') {
                    ...
                    <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="clientCode" name="clientCode" placeholder="Code Client" disabled = "true" autocomplete="off" value="<?php echo $_SESSION['codeClient']; ?>" />
                            </div>
                        </div> <!--/form-group-->
                ...
                <?php } else if($_GET['o'] == 'manord') {
					...
					WHERE orders.order_id = {$orderId}";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete="off" disabled="true" value="<?php echo $data[2] ?>" />
                            </div>
                        </div> <!--/form-group-->
                        <div class="form-group">
