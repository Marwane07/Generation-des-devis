<?php 
require_once '../stock/php_action/db_connect.php';
require_once '../stock/includes/header.php';
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="../stock/php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                    <label for="clientCode" class="col-sm-2 control-label">Code Client</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="clientCode" name="clientCode" placeholder="Code Client" autocomplete="off" />
                    </div>
                </div> <!--/form-group-->
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="../stock/php_action/editOrder.php" id="editOrderForm">
...
<?php //require_once '../stock/includes/footer.php'; ?>
